...
# The EmptyOperator is a lightweight operator in Apache Airflow 
# that performs no actual work—it simply acts as a placeholder or marker 
# within your DAGs (Introduction to DAGs in Airflow). 
# When executed, it immediately completes with a success status,
#  making it an ideal tool for structuring workflows,